...
CUDA_VISIBLE_DEVICE=0 python train.py --experiment_suffix vocab_64_embed384_muon120k_no_tying --warmup_steps 6000 --max_steps 120000 --n_embd 384 --eval_interval 5000 --no_tying